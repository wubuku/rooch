...
import org.test.roochblogdemo.domain.article.ArticleEvent.*;
...
public abstract class AbstractArticleState implements ArticleState.SqlArticleState, Saveable {
    ...
    public void when(AbstractArticleEvent.CommentUpdated e) {
        ...
        ArticleState updatedArticleState = (ArticleState) ReflectUtils.invokeStaticMethod(
                    ...
                    new Object[]{this, commentSeqId, commenter, body, owner, roochEventId, roochSender, roochTxHash, roochTypeTag, roochTimestampMs, roochBlockHeight, roochEventIndex, status, MutationContext.forEvent(e, s -> {if (s == this) {return this;} else {throw new UnsupportedOperationException();}})}
            );

//package org.test.roochblogdemo.domain.article;
//
//public class UpdateCommentLogic {
//    public static ArticleState mutate(ArticleState articleState, BigInteger commentSeqId, String commenter, String body, String owner, RoochEventId roochEventId, String roochSender, String roochTxHash, String roochTypeTag, Long roochTimestampMs, BigInteger roochBlockHeight, Long roochEventIndex, String status, MutationContext<ArticleState, ArticleState.MutableArticleState> mutationContext) {
//    }
//}
    ...
    public void when(AbstractArticleEvent.CommentRemoved e) {
        ...
        ArticleState updatedArticleState = (ArticleState) ReflectUtils.invokeStaticMethod(
                    ...
                    new Object[]{this, commentSeqId, roochEventId, roochSender, roochTxHash, roochTypeTag, roochTimestampMs, roochBlockHeight, roochEventIndex, status, MutationContext.forEvent(e, s -> {if (s == this) {return this;} else {throw new UnsupportedOperationException();}})}
            );

//package org.test.roochblogdemo.domain.article;
//
//public class RemoveCommentLogic {
//    public static ArticleState mutate(ArticleState articleState, BigInteger commentSeqId, RoochEventId roochEventId, String roochSender, String roochTxHash, String roochTypeTag, Long roochTimestampMs, BigInteger roochBlockHeight, Long roochEventIndex, String status, MutationContext<ArticleState, ArticleState.MutableArticleState> mutationContext) {
//    }
//}
...
//}
    ...
    public void when(AbstractArticleEvent.ArticleCreated e) {
        ...
        ArticleState updatedArticleState = (ArticleState) ReflectUtils.invokeStaticMethod(
                    ...
                    new Object[]{this, title, body, roochEventId, roochSender, roochTxHash, roochTypeTag, roochTimestampMs, roochBlockHeight, roochEventIndex, status, MutationContext.forEvent(e, s -> {if (s == this) {return this;} else {throw new UnsupportedOperationException();}})}
            );

//package org.test.roochblogdemo.domain.article;
//
//public class CreateLogic {
//    public static ArticleState mutate(ArticleState articleState, String title, String body, RoochEventId roochEventId, String roochSender, String roochTxHash, String roochTypeTag, Long roochTimestampMs, BigInteger roochBlockHeight, Long roochEventIndex, String status, MutationContext<ArticleState, ArticleState.MutableArticleState> mutationContext) {
//    }
//}
...
//    public static ArticleState mutate(ArticleState articleState, RoochEventId roochEventId, String roochSender, String roochTxHash, String roochTypeTag, Long roochTimestampMs, BigInteger roochBlockHeight, Long roochEventIndex, String status, MutationContext<ArticleState, ArticleState.MutableArticleState> mutationContext) {
//    }
//}
